...
ALTER TABLE trips
    ADD COLUMN vehicle_token_id int NOT NULL CONSTRAINT trips_vehicle_token_id_fkey REFERENCES vehicles (token_id);

ALTER TABLE trips
    DROP COLUMN user_device_id;

ALTER TABLE trips
    ADD COLUMN encryption_key bytea;

ALTER TABLE trips
    ADD COLUMN bundlr_id varchar;
-- +goose StatementEnd
