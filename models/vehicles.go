...
var (
	vehicleAllColumns            = []string{"token_id", "user_device_id"}
...
func (vehicleL) LoadVehicleTokenTrips(ctx context.Context, e boil.ContextExecutor, singular bool, maybeVehicle interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`trips_api.trips.vehicle_token_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Vehicle) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"trips_api\".\"vehicles\"", updateOnConflict, ret, update, conflict, insert, opts...)
