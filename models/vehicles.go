...
var VehicleWhere = struct {
	...
	TokenID:      whereHelperint{field: "\"trips_api\".\"vehicles\".\"token_id\""},
	UserDeviceID: whereHelperstring{field: "\"trips_api\".\"vehicles\".\"user_device_id\""},
	OwnerAddress: whereHelpernull_Bytes{field: "\"trips_api\".\"vehicles\".\"owner_address\""},
}
...
var (
	vehicleAllColumns            = []string{"token_id", "user_device_id", "owner_address"}
	vehicleColumnsWithoutDefault = []string{"token_id", "user_device_id"}
	vehicleColumnsWithDefault    = []string{"owner_address"}
...
func (vehicleL) LoadVehicleTokenTrips(ctx context.Context, e boil.ContextExecutor, singular bool, maybeVehicle interface{}, mods queries.Applicator) error {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.TokenID == foreign.VehicleTokenID {
...
func FindVehicle(ctx context.Context, exec boil.ContextExecutor, tokenID int, selectCols ...string) (*Vehicle, error) {
	vehicleObj := &Vehicle{}
...
func VehicleExists(ctx context.Context, exec boil.ContextExecutor, tokenID int) (bool, error) {
	var exists bool
