...
docker: deps
	@docker build -f ./resources/docker/Dockerfile . -t dimozone/trips-api:$(VER_CUT)
	@docker tag dimozone/trips-api:$(VER_CUT) dimozone/trips-api:latest

docker-cgo: deps
	@docker build -f ./resources/docker/Dockerfile.cgo . -t dimozone/trips-api:$(VER_CUT)-cgo
	@docker tag dimozone/trips-api:$(VER_CUT)-cgo dimozone/trips-api:latest-cgo
...
test: $(APPS)
	...
	@$(PATHINSTBIN)/trips-api test ./config/test/...
